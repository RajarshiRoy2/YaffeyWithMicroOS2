...
#define  OS_EVENT_TYPE_NESTED_MUTEX   6u
...
#define OS_NESTING_ERR              178u	/* TN -- Mutex nesting overflow */
#define OS_RESOURCE_NOT_AVAILABLE   179u    /* TN -- Mutex not available */
...
typedef struct os_event {
    ...
    INT8U    OSEventNesting;                 /* TN - Extra for nested mutex                             */
